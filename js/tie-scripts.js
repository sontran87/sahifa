jQuery(document).ready(function() {
  ...
  if (tie.lightbox_all) {
    $the_post
      .find('div.entry a')
      .not(
        'div.entry .gallery a, div.entry .wp-block-gallery a, div.entry .flat-social a'
      )
      .each(function(i, el) {
  ...
  if (tie.lightbox_gallery) {
    $the_post
      .find('div.entry .gallery a, div.entry .wp-block-gallery a')
      .each(function(i, el) {
        var href_value = el.href;
        if (/\.(jpg|jpeg|png|gif)$/.test(href_value)) {
    ...
    $the_post
      .find('.ilightbox-gallery')
      .iLightBox({
        skin: tie.lightbox_skin,
        path: tie.lightbox_thumb,
        controls: { arrows: tie.lightbox_arrows }
      });
  }
  jQuery(
    'section.videos-lightbox a.single-videolighbox, .lightbox-img'
  ).iLightBox({
    skin: tie.lightbox_skin,
    path: tie.lightbox_thumb,
    controls: { arrows: tie.lightbox_arrows }
  ...
  jQuery('#slide-out-open').click(function() {
    if (jQuery(this).hasClass('slide-out-open')) {
      ...
      jQuery(this)
        .removeClass('slide-out-open')
        .addClass('slide-out-close');
      return false;
    } else if (jQuery(this).hasClass('slide-out-close')) {
      $wrapper.css({ overflow: 'auto' });
      jQuery('body').removeClass('js-nav');
      jQuery(this)
        .removeClass('slide-out-close')
        .addClass('slide-out-open');
      return false;
    }
  });
  if (
  ...
  if (tie.mobile_menu_active) {
    ...
    mobileItems
      ...
      .append('<i class="mobile-arrows fa fa-chevron-down"></i>');
  ...
  jQuery('#mobile-menu li.menu-item-has-children i.mobile-arrows').click(
    function() {
  ...
  jQuery('#main-nav li.mega-menu:not(#main-nav li li)').hover(function() {
    ...
    jQuery(this)
      .find('div.mega-menu-block')
      .css({ left: '-' + PositionLeft + 'px', width: menuWidth });
  });
  jQuery('div.mega-cat-wrapper').each(function() {
    jQuery(this)
      .find('div.mega-cat-content-tab')
      .hide();
    jQuery(this)
      .find('ul.mega-cat-sub-categories li:first')
      .addClass('cat-active')
      .show();
    jQuery(this)
      .find('div.mega-cat-content-tab:first')
      .addClass('already-loaded')
      .show();
    jQuery(this)
      .find('ul.mega-cat-sub-categories li')
  ...
  if (userAgent.match(/iPad/i)) {
    if (userAgent.search('Safari') >= 0 && userAgent.search('Chrome') < 0) {
      jQuery(
        '#main-nav li.menu-item-has-children a, #main-nav li.mega-menu a, #top-nav li.menu-item-has-children a'
      ).attr('onclick', 'return true');
    }
  }
  jQuery('div.cat-box-content').each(function() {
    jQuery(this)
      .find('div.cat-tabs-wrap')
      .hide();
    jQuery(this)
      .find('div.cat-tabs-header ul li:first')
      .addClass('active')
      .show();
    jQuery(this)
      .find('div.cat-tabs-wrap:first')
      .show();
    jQuery(this)
      .find('div.cat-tabs-header ul li')
      .click(function(event) {
        event.preventDefault();
        jQuery(this)
          .parent()
  ...
  jQuery('#tabbed-widget ul.posts-taps li:first')
    .addClass('active')
    .show();
  ...
  $window.smartresize(function() {
    jQuery('div.group_items-box').each(function(i, el) {
      var groups_height = jQuery(this)
        .find('div.group_items:first-child')
        .height();
      ...
      reading_content.imagesLoaded(function() {
        ...
        $window.scroll(function() {
          ...
          if (window_offest > content_offset) {
            percent =
              (100 * (window_offest - content_offset)) /
...
jQuery(function() {
  ...
  function tieRevealOnScroll() {
    ...
    jQuery(
      'body.lazy-enabled #theme-footer div.post-thumbnail, body.lazy-enabled #main-content div.post-thumbnail, body.lazy-enabled #main-content img:not(.ei-slider-thumbs img), body.lazy-enabled #featured-posts'
    ).each(function() {
...
var tie_isMobile = {
  ...
  any: function() {
    return (
      tie_isMobile.Android() ||
      tie_isMobile.BlackBerry() ||
      tie_isMobile.iOS() ||
      tie_isMobile.Opera() ||
      tie_isMobile.Windows()
    );
  }
};
(function(e, t) {
...
(function(a, b, c) {
  ...
  b.Slideshow.prototype = {
    _init: function(a) {
      ...
      this.current = 0;
      var c = this;
      this.$loading = b('<div class="ei-slider-loading"></div>').prependTo(
        c.$el
      );
    ...
    _initThumbs: function() {
      ...
      this.$sliderthumbs
        .css('max-width', this.options.thumbMaxWidth * this.itemsCount + '%')
        .show();
    },
    ...
    _slideTo: function(a) {
      ...
      b.when(
        ...
        d
          .css(f)
          .stop()
          .animate(g, this.options.speed, this.options.easing),
        this.$sliderElem
          .stop()
          .animate(
...
(function($) {
  ...
  $.fn.innerFade = function(options) {
    return this.each(function() {
      ...
      $fade_object.elements =
        $fade_object.settings.children === null
          ? $($fade_object.container).children()
          : $($fade_object.container).children($fade_object.settings.children);
      $fade_object.count = 0;
      ...
      if ($fade_object.elements.length > 1) {
        ...
        for (var i = 0; i < $fade_object.elements.length; i++) {
          $($fade_object.elements[i])
            .hide(0)
            .css('z-index', String($fade_object.elements.length - i))
        ...
        if ($fade_object.settings.type == 'random') {
          ...
          toHide =
            $fade_object.settings.first_slide == 0
              ? $fade_object.elements.length - 1
              : $fade_object.settings.first_slide - 1;
        }
  ...
  $.fn.innerFadeTo = function(slide_number) {
    return this.each(function(index) {
      ...
      var currentItemIndex = $($fade_object.elements).index(
        $currentVisibleItem
      );
  ...
  $.fadeToItem = function($fade_object, toShow, toHide) {
    ...
    switch ($fade_object.settings.animationType) {
      ...
      case 'slideOver':
        ...
        $($fade_object.elements[toShow])
          .css(to_show_css)
          .show();
        $($fade_object.elements[toHide]).animate(
          to_hide_animation,
          speed,
          $fade_object.settings.easing,
          function() {
            $(this).hide();
          }
        );
        $($fade_object.elements[toShow]).animate(
          to_show_animation,
          speed,
          $fade_object.settings.easing
        );
    ...
    if (
      $fade_object.settings.indexContainer ||
      $fade_object.settings.callback_index_update
    ) {
      $.updateIndexes($fade_object, toShow);
    }
  };
  $.fadeTimeout = function($fade_object, toShow, toHide, firstRun) {
    if (window.isActive) {
      ...
      $fade_object.count++;
      if (
        $fade_object.settings.loop == false &&
        $fade_object.count >= $fade_object.elements.length
      ) {
        $.stopSlideshow($fade_object);
        return;
      }
    ...
    var timeout =
      firstRun && $fade_object.settings.startDelay
        ? $fade_object.settings.startDelay
        : $fade_object.settings.timeout;
    $($fade_object.container).data(
      'current_timeout',
      setTimeout(function() {
  ...
  $.bindControls = function($fade_object) {
    $($fade_object.settings.nextLink).on('click', function(event) {
      ...
      var $nextElement =
        $currentElement.next().length > 0
          ? $currentElement.next()
          : $($fade_object.elements).filter(':first');
    ...
    $($fade_object.settings.prevLink).on('click', function(event) {
      ...
      var currentElementIndex = $($fade_object.elements).index($currentElement);
      var $previousElement =
        $currentElement.prev().length > 0
          ? $currentElement.prev()
          : $($fade_object.elements).filter(':last');
      var previousElementIndex = $($fade_object.elements).index(
        $previousElement
      );
  ...
  $.bind_pause = function($fade_object) {
    $($fade_object.settings.pauseLink)
      .unbind()
      .click(function(event) {
        event.preventDefault();
        if ($($fade_object.container).data('current_timeout') != null) {
          ...
          var previousItem = '';
          if ($fade_object.settings.type == 'random') {
            previousItem = Math.floor(
              Math.random() * $fade_object.elements.length
            );
            do {
              nextItem = Math.floor(
                Math.random() * $fade_object.elements.length
            ...
            previousItem = $(tag, $($fade_object.container)).index(
              $(tag + ':visible', $($fade_object.container))
            );
            nextItem =
              previousItem + 1 == $fade_object.elements.length
                ? 0
                : previousItem + 1;
          }
  ...
  $.bindCancel = function($fade_object) {
    $($fade_object.settings.cancelLink)
      .unbind()
      .click(function(event) {
        event.preventDefault();
        $.stopSlideshow($fade_object);
  ...
  $.linkIndexes = function($fade_object) {
    ...
    if ($indexContainerChildren.size() == $fade_object.elements.length) {
      ...
      alert(
        'There is a different number of items in the menu and slides. There needs to be the same number in both.\nThere are ' +
          $indexContainerChildren.size() +
          ' in the indexContainer.\nThere are ' +
          $fade_object.elements.length +
          ' in the slides container.'
      );
    }
  };
          ...
          (e.onScroll = function(e) {
            if (e.stickySidebar.is(':visible')) {
              ...
              if (
                ...
                var n,
                  s = e.paddingTop + e.marginTop + t.additionalMarginTop,
                  c =
                  ...
                  l =
                    e.stickySidebar.outerHeight() + s + c < i(window).height();
                n = l
                ...
                'fixed' == e.stickySidebar.css('position') && (h += m),
                  (h =
                    m > 0
                      ? Math.min(h, g)
                      : Math.max(h, n - e.stickySidebar.outerHeight())),
                  (h = Math.max(h, f)),
                  (h = Math.min(h, S - e.stickySidebar.outerHeight()));
                var u = e.container.height() == e.stickySidebar.outerHeight();
                r =
                  (u || h != g) && (u || h != n - e.stickySidebar.outerHeight())
                    ? d + h - e.sidebar.offset().top - e.paddingTop <=
